        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative group max-w-md w-full">
              {/* Outer Glow Border */}
              <div className="absolute -inset-2 bg-gradient-to-tr from-sky-500 via-indigo-500 to-sky-400 rounded-3xl blur-xl opacity-25 group-hover:opacity-50 transition-opacity"></div>
              ...
              <div className="relative glass-panel rounded-3xl overflow-hidden border-slate-800 shadow-2xl p-3 bg-slate-950/80">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-slate-950/85 backdrop-blur-md border border-slate-800 flex items-center justify-between text-left">
                  ...
                  <div className="w-10 h-10 rounded-xl bg-sky-500/20 text-sky-400 flex items-center justify-center font-bold shrink-0 border border-sky-500/30">
          ...
          <div className="lg:col-span-7 text-left space-y-6">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
              Hi, I'm <span className="text-sky-400">Abey Johnson</span>
            </h3>
                    ...
                    <div className="truncate">
                      ...
                      {info.isEmail ? (
                        <a
                          ...
                          className="text-xs sm:text-sm font-bold text-sky-400 hover:underline truncate block"
                        >
                          {info.value}
                        </a>
                      ) : (
            ...
            {/* Actions: Primary Red CV Button + Text Link */}
            <div className="pt-4 flex items-center gap-6">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white bg-red-600 hover:bg-red-500 border border-red-500 shadow-lg shadow-red-600/30 hover:opacity-95 transition-all cursor-pointer"
              >
              ...
              <a
                href="#contact"
                className="text-sm font-bold text-sky-400 hover:text-sky-300 hover:underline flex items-center gap-1 transition-colors"
              >
