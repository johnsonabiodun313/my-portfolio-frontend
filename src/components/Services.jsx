            ...
            return (
              ...
              >
                <div className="space-y-4">
                  <div className="w-14 h-14 rounded-2xl bg-sky-500 p-3 text-slate-950 shadow-lg shadow-sky-500/25 group-hover:scale-110 transition-transform">
                ...
                <div className="pt-6 mt-4 border-t border-slate-800 flex items-center justify-between text-xs text-sky-400 font-semibold">
