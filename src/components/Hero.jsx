...
export default function Hero({ onShowToast }) {
  ...
  return (
    <section id="home" className="relative pt-28 sm:pt-32 pb-16 sm:pb-20 overflow-hidden">
      {/* Background Amber & Indigo Glows */}
      <div className="glow-amber w-96 h-96 bg-amber-500 top-10 left-1/4 -z-10 blur-3xl"></div>
      <div className="glow-amber w-80 h-80 bg-indigo-600 top-40 right-10 -z-10 blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="space-y-2">
              ...
              <h1 className="text-3xl sm:text-6xl font-black text-white tracking-tight leading-[1.1]">
                Abey <span className="text-gradient-gold">Johnson</span>
              </h1>
              <p className="text-lg sm:text-2xl font-semibold text-indigo-400 pt-1">
            ...
            <p className="text-sm sm:text-lg text-slate-300 max-w-2xl leading-relaxed">
              ...
              <strong className="text-amber-400">Tailwind CSS</strong>. Focused on elegant design, clean architecture, and rapid deployment.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl font-bold text-slate-950 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:opacity-95 shadow-xl shadow-amber-500/25 transition-all hover:scale-[1.02] active:scale-98 text-sm"
              >
                <span>Hire Me</span>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 sm:px-5 py-3 sm:py-3.5 rounded-xl font-semibold text-slate-200 glass-panel glass-panel-hover text-sm cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-3 sm:py-3.5 rounded-xl font-medium text-slate-300 glass-panel glass-panel-hover text-xs sm:text-sm cursor-pointer"
                ...
                {[
                  ...
                  return (
                    <a
                      ...
                      className="p-2.5 rounded-xl glass-panel text-slate-400 hover:text-amber-400 hover:bg-slate-800 transition-all hover:scale-110"
                    >
          ...
          {/* Right Column: Mobile-responsive Code Window Graphic */}
          <div className="lg:col-span-5 w-full overflow-hidden">
            <div className="relative w-full">
              <div className="absolute -inset-1 bg-gradient-to-r from-amber-500 via-indigo-500 to-amber-400 rounded-2xl blur-lg opacity-30 animate-pulse"></div>

              <div className="relative glass-panel rounded-2xl p-4 sm:p-6 border-slate-800 shadow-2xl text-left w-full overflow-hidden">
                <div className="flex items-center justify-between pb-3 sm:pb-4 mb-3 sm:mb-4 border-b border-slate-800">
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] sm:text-xs text-slate-400 font-mono">
                    ...
                    <span>abey.config.ts</span>
                  </div>
                </div>

                {/* Code Window Container with Responsive Text Wrapping & Scroll Protection */}
                <div className="space-y-1.5 sm:space-y-2 font-mono text-[11px] sm:text-xs text-slate-300 leading-relaxed overflow-x-auto whitespace-pre-wrap break-words">
                  ...
                  <div className="pl-3 sm:pl-4">
                    ...
                    <span className="text-emerald-300">'Abey Johnson'</span>,
                  </div>
                  <div className="pl-3 sm:pl-4">
                    <span className="text-slate-400">email:</span>{' '}
                    <span className="text-amber-300">'abeyjohnsona@gmail.com'</span>,
                  </div>
                  <div className="pl-3 sm:pl-4">
                  ...
                  <div className="pl-6 sm:pl-8 text-amber-300">
                    'React', 'Vite', 'Node.js', 'Tailwind', 'PostgreSQL'
                  </div>
                  <div className="pl-3 sm:pl-4">],</div>
                  <div className="pl-3 sm:pl-4">
                    <span className="text-slate-400">status:</span>{' '}
                    <span className="text-indigo-300">'🟢 Open for Projects'</span>
                  </div>
                  <div>&#125;</div>
                </div>
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {heroStats.map((stat, index) => (
            <div
              key={index}
              className="glass-panel p-4 sm:p-5 rounded-2xl border-slate-800 hover:border-amber-500/30 transition-all text-center group"
            >
              <div className="text-2xl sm:text-4xl font-black text-white group-hover:text-amber-400 transition-colors">
                {stat.value}
              </div>
